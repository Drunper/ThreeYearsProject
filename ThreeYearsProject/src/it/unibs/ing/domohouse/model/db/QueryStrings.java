...
public class QueryStrings {
	...
	public static final String GET_RULES = "SELECT nome_regola, stato, testo_antecedente, testo_conseguente"
			+ " FROM regola" + " WHERE nome_utente =? AND nome_unità =?";
	public static final String GET_ASSOCIATED_SENSOR_CATEGORY_ROOM = "SELECT nome_categoria_sensori"
			+ " FROM misura_stanze JOIN sensore ON (misura_stanze.nome_sensore = sensore.nome_sensore AND misura_stanze.nome_unità = sensore.nome_unità AND misura_stanze.nome_utente = sensore.nome_utente)"
			+ " WHERE misura_stanze.nome_unità =? AND misura_stanze.nome_utente =? AND nome_stanza =?";
	public static final String GET_ASSOCIATED_SENSOR_CATEGORY_ARTIFACT = "SELECT nome_categoria_sensori"
			+ " FROM misura_artefatti JOIN sensore ON (misura_artefatti.nome_sensore = sensore.nome_sensore AND misura_artefatti.nome_unità = sensore.nome_unità AND misura_artefatti.nome_utente = sensore.nome_utente)"
			+ " WHERE misura_artefatti.nome_unità =? AND misura_artefatti.nome_utente =? AND nome_artefatto =?";
	public static final String GET_ASSOCIATED_ACTUATOR_CATEGORY_ROOM = "SELECT nome_categoria_attuatori"
			+ " FROM controlla_stanze JOIN attuatore ON (controlla_stanze.nome_attuatore = attuatore.nome_attuatore AND controlla_stanze.nome_unità = attuatore.nome_unità AND controlla_stanze.nome_utente = attuatore.nome_utente)"
			+ " WHERE controlla_stanze.nome_unità =? AND controlla_stanze.nome_utente =? AND nome_stanza =?";
	public static final String GET_ASSOCIATED_ACTUATOR_CATEGORY_ARTIFACT = "SELECT nome_categoria_attuatori"
			+ " FROM controlla_artefatti JOIN attuatore ON (controlla_artefatti.nome_attuatore = attuatore.nome_attuatore AND controlla_artefatti.nome_unità = attuatore.nome_unità AND controlla_artefatti.nome_utente = attuatore.nome_utente)"
			+ " WHERE controlla_artefatti.nome_unità =? AND controlla_artefatti.nome_utente =? AND nome_artefatto =?";
